...
int AssociarDisciplinaAluno(){
    ...
    for (int i = 0; i < alunos.size(); i++)
    {
        if (strcmp(nome_aluno[1], convert_array[1]))
        {
            ...
            cin >> index;
            printf("O aluno pode possuir ate [%d] disciplinas, digite uma posicao para inserir: ", N_DISCIPLINAS);
            cin >> idx_disciplinas;
...
int AssociarDisciplinaProfessor(){
    ...
    for (int i = 0; i < p.size(); i++)
    {
        if (strcmp(nome_professor[1], convert_array[1]))
        {
            ...
            cin >> index;
            printf("O professor pode possuir ate [%d] disciplinas, digite uma posicao para inserir: ", N_DISCIPLINAS);
            cin >> idx_disciplinas;
